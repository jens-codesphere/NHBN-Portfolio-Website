        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="mb-10">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <a href="https://github.com/jens-codesphere" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-5 py-3 bg-sapphire hover:bg-bridal transition-all rounded-sm text-white hover:text-midnight font-body font-semibold text-sm">
                <Github size={18} />
                <span>GitHub</span>
              </a>
              <a href="https://www.linkedin.com/in/bao-ngoc-nguyen-hoang-a0a5a6340/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-5 py-3 bg-sapphire hover:bg-bridal transition-all rounded-sm text-white hover:text-midnight font-body font-semibold text-sm">
                <Linkedin size={18} />
                <span>LinkedIn</span>
              </a>
              <a href="https://www.facebook.com/baongoc.nguyenhoang.5811/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-5 py-3 bg-sapphire hover:bg-bridal transition-all rounded-sm text-white hover:text-midnight font-body font-semibold text-sm">
                <Facebook size={18} />
                <span>Facebook</span>
              </a>
            </div>
